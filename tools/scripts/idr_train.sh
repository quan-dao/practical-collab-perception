...
#SBATCH --time=00:07:00                                 # check the TIME limit TRAINING != EVAL
...
set -x
srun python -u train.py --launcher slurm --cfg_file cfgs/nuscenes_models/cbgs_dyn_pp_centerpoint.yaml --batch_size 12 \
    --sync_bn --fix_random_seed \
    --extra_tag test_div8_bs12
