...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None, use_nuscenes_cls=False):
    ...
    if not use_nuscenes_cls:
        ...
        overlap_0_7 = np.array([[0.7, 0.7, 0.7, 0.7, 0.7, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5], 
                            [0.7, 0.7, 0.7, 0.7, 0.7, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5],
                            [0.7, 0.7, 0.7, 0.7, 0.7, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5]])
        overlap_0_5 = np.array([[0.7, 0.7, 0.7, 0.7, 0.7, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5], 
